...
export const regionalBlendsDetailed = [
  {
    ...
    climateTags: ["Cold Zones", "Orchard Soil", "Moisture Sensitive"],
    cropTags: ["Apple", "Saffron", "Almond", "Walnut", "Pear", "Cherry", "Apricot", "Plum"],
  ...
  },
  {
    ...
    climateTags: ["Dry Heat", "Sandy Soil", "Low Moisture"],
    cropTags: ["Cotton", "Groundnut", "Cumin", "Castor", "Bajra", "Sesame", "Citrus", "Mango"],
  ...
  },
  {
    ...
    climateTags: ["High Crop Cycle", "Soil Recovery", "Carbon Depletion"],
    cropTags: ["Wheat", "Paddy", "Sugarcane", "Mustard", "Maize", "Potato", "Cotton", "Barley"],
    formulationSupport: 'Optimized for fast soil carbon restoration and cellular structure conditioning after intensive fertilizer-heavy crop rotation cycles.',
  ...
  },
  {
    ...
    climateTags: ["Humid Regions", "Laterite Soil", "Plantation Zones"],
    cropTags: ["Coffee", "Tea", "Cardamom", "Pepper", "Coconut", "Banana", "Rubber", "Turmeric"],
  ...
  },
  {
    ...
    climateTags: ["Black Cotton Soil", "Dryland Farms", "Variable Rainfall"],
    cropTags: ["Soybean", "Cotton", "Chickpea", "Pigeon Pea", "Wheat", "Maize", "Linseed", "Mustard"],
  ...
  },
  {
    ...
    climateTags: ["Mixed Soil", "Home Garden", "General Conditioning"],
    cropTags: ["Tomato", "Chilli", "Brinjal", "Okra", "Spinach", "Coriander", "Rose", "Marigold"],
